...
def record_audio_and_save(save_path, n_times=1000):
    """
    ...
    try:
        initcount = len(os.listdir(save_path))
    except:
        pass
    ...
    for i in range(n_times):
        ...
        sd.wait()
        write(save_path + str(i+initcount) + ".wav", fs, myrecording)
        input(
...
record_audio_and_save("NewHeadPhones/", n_times=1000)
