...
walley_sample = "audio/R0005.wav"
data, sample_rate = librosa.load(walley_sample)
#rate, data2 = wavfile.read(walley_sample)
...
data_path_dict = {
    0: ["KH_Recordings/background_sound/" + file_path for file_path in os.listdir("KH_Recordings/background_sound")],
    1: ["KH_Recordings/Hamada/" + file_path for file_path in os.listdir("KH_Recordings/Hamada/")]
}
